...
dduper is implemented in Rust. Please be aware that dduper is beta quality tool, so _validate_ it, before running it on your critical data.
...
|-----------|----------------|---------|---------|
| 1 GB      | 8.68s          | 0.26s   | 33x     |
| 5 GB      | 41.62s         | 1.03s   | 40x     |
| 10 GB     | 83.05s         | 2.09s   | 40x     |
| 20 GB     | 168.62s        | 4.18s   | 40x     |
| 50 GB     | 422.88s        | 10.23s  | 41x     |
| 100 GB    | 850.20s        | 20.29s  | 42x     |
